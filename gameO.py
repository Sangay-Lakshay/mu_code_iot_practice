    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if pos[0] > 180 and pos[0] < 510 and pos[1] > 500 and pos[1] < 600:
                    if clicked == False:
                        CurColor = (255,0,0)
                    game_loop()
        ...
        game_font = pygame.freetype.Font("Font.ttf", 75)
        text_surface, rect = game_font.render(("Beyond Roof"), (0, 0, 0))
        ...
        if pos[0] > 180 and pos[0] < 380 and pos[1] > 500 and pos[1] < 600:
            pygame.draw.rect(gameDisplay,(200,0,0),(310,500,200,100),0)
        else:
            pygame.draw.rect(gameDisplay,(255,0,0),(310,500,200,100),0)
        ...
        gameDisplay.blit(text_surface, (325, 540))
    ...
    while game_run == True:
        ...
        for event in pygame.event.get():
            ...
            if sensor.distance > 1:
                if sensor.distance < 20 and JumpAllowed == True:
                    tempX = x_change
                    if tempX <= 0:
                        tempX *= -1
                    gravity = -1 * tempX - 10
